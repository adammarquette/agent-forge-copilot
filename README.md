...
| Doc | ~tok | Purpose |
|---|---|---|
| [`INDEX.md`](documentation/INDEX.md) | 3.0K | **Start here** — the wiki's front door: documents catalog + the requirement/use-case → **code project** map the `.slnx` doesn't carry |
...
| [`DEPLOYMENT.md`](documentation/DEPLOYMENT.md) | 7.6K | The container stack — operational runbook (bootstrap, config, quirks, rollback) and the physical/network view |
